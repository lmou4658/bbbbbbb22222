...
// Friendly alias for the OpenRouter fast model (routes via MODEL_ALIASES in chat.ts)
CLAUDE_MODELS.push("claude-opus-4.6-fast");
...
const OPENROUTER_MODELS = [
  ...
  "anthropic/claude-opus-4.6-fast", "anthropic/claude-opus-4.6-fast:thinking",
];
